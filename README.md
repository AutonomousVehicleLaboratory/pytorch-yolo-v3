...
## Detection of objects in video Example

[Video Example](https://drive.google.com/file/d/18CciybO0tLUd1dBrsXwd0e9jfu2WKhtU/view?usp=sharing)

To reproduce the result above for object detection in video, clone this repo, navigate to its root folder and do:

```
conda env create -f environment.yml
source activate yolo3_pt
pip install opencv_python
wget https://pjreddie.com/media/files/yolov3.weights
python video_demo.py --video dash_cam_footage --save_to demo.avi
```

After inference, the video with the bounding box superimposed is demo.avi.
